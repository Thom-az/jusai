...
<head>
    ...
    <title>Acesso negado | {{ config('jusai.brand.name', 'JusAI') }}</title>
    <script>
...
<div class="error-page">
    <div class="error-card">
        ...
        <div class="error-icon-wrap">
            <i class="bi bi-shield-lock" style="font-size: 1.75rem; color: var(--jusai-danger, #b91c1c);"></i>
        </div>
        ...
        <p class="error-description">
            ...
            Fale com o administrador do seu escritório se precisar de acesso.
        </p>
